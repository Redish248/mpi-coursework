...
public class TripServiceImpl implements TripService {
    ...
    public void createTripRequest(TripRequest request, String username) {
        if (username != null) {
            request.setTraveler(userRepository.findByName(username));
    ...
    public void cancelRequest(TripRequest request, String username) {
        if (request.getTraveler().getName().equals(username)) {
    ...
    public void rejectRequest(TripRequest request, String username) {
        if (request.getCrew().getCrewOwner().getName().equals(username) ||
                request.getShip().getOwner().getName().equals(username)) {
